      ...
      <div className="hidden md:block flex-1 max-w-sm mx-4">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-7 h-7 text-xs bg-white/50 border border-black/30 focus:bg-white/80 transition-all duration-200"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="relative h-8 w-auto px-2 hover:bg-white/20 transition-colors"
            >
              <div className="flex items-center gap-2">
          ...
          <DropdownMenuContent className="w-48" align="end" forceMount>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-xs" onClick={() => GoToProfile()}>
              My Profile
            </DropdownMenuItem>
